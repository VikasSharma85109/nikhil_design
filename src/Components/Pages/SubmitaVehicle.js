                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="plan_card">
                            <div className="plan_cardHead">
                                <h4>classNameic</h4>
                                <div className="plan_Price">$99 <span className="plan_Time">Month</span></div>
                            </div>
                            ...
                            <div className="plan_cardFooter">
                                <a href="#" className="gry_btn">SUBMIT A VEHICLE</a>
                            </div>
                        </div>
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="plan_card plan_Plus">
                            <div className="plan_cardHead">
                                <h4>Plus</h4>
                                <div className="plan_Price">$499 <span className="plan_Time">Month</span></div>
                            </div>
                            <div className="plan_cardBody">
                                <ul className="plan_point">
                                    <li>Lorem Ipsum is simply dummy text</li>
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="plan_card plan_WhiteGlove">
                            <div className="plan_cardHead">
                                <h4>White Glove</h4>
                                <div className="plan_Price">$999 <span className="plan_Time">Year</span></div>
                            </div>
                            <div className="plan_cardBody">
                                <ul className="plan_point">
                                    <li>Lorem Ipsum is simply dummy text</li>
