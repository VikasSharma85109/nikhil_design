        ...
        <section className="ptb_80 pt_sm_50">
            <div className="container">
                <div className="row">
                    ...
                    <p>These Terms of Use (including the binding arbitration provision located here) along with our <a href="https://bringatrailer.com/privacy-notice/" target="_blank" rel="noopener noreferrer">Privacy Notice</a>, any <a href="https://bringatrailer.com/faq/" target="_blank" rel="noopener noreferrer">FAQs</a>, and any additional guidelines, terms, procedures or rules that may apply to a specific feature of the Digital Services (collectively, the “Agreement”) that are owned or operated by Bring a Trailer Media, LLC or its affiliates (“we”, “us”, “our” or “BaTMedia”), are a contract in electronic form between you (“you,” “your,” and “yourself”) and BaTMedia. This Agreement applies to the extent you use the Digital Services to (a) act as a “Buyer” submitting bids expressing an intent to purchase vehicles or other products and services listed by Sellers on the Digital Services, (b) act as a “Seller” submitting information in connection with the listing of a vehicle or other product or service on a Digital Service by BaTMedia on your behalf or (c) as a visitor, registrant or user in any other capacity permitted by these terms (together with “Buyers” and “Sellers”, collectively, “Users”). This Agreement sets forth the legally binding terms governing your access and use of the Digital Services. This Agreement applies to BaTMedia and its affiliates only and does not cover other companies, including third parties that may advertise or sponsor content, products or services on the Digital Services or any third-party platforms (such as social media platforms or app stores) or other channels that you may use to access the Digital Services or any Content (as defined below).</p>
                    ...
                    <p>As part of the Digital Services, BaTMedia may assist Sellers in the creation of their listings (including the content of such listing) but it remains each Seller’s responsibility to make sure that its listings are accurate.</p>
                    <p>BATMEDIA IS NOT AN AUTOMOBILE BROKER, DEALER OR TRADITIONAL AUCTIONEER AND WE DO NOT SELL, EXCHANGE, BUY, OR OFFER FOR SALE, NEGOTIATE OR ATTEMPT TO NEGOTIATE, A SALE OR EXCHANGE OF AN INTEREST IN ANY VEHICLE LISTED ON THE DIGITAL SERVICES. BATMEDIA HAS NOT EVERNEVER: (I) HELD TITLE FOR ANY VEHICLE LISTED ON THE DIGITAL SERVICES, (2) INSPECTED ANY VEHICLE LISTED ON THE DIGITAL SERVICES OR (3) HAD ANY VEHICLES LISTED ON THE DIGITAL SERVICES IN ITS LEGAL POSSESSION.</p>
